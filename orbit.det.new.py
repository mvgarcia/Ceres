...
Ar= np.array([[19.,13.,20.38],[18.,41.,48.08],[18.,14.,30.53]])# prueba
Dec=np.array([[34.,10.,8.8],[36.,15.,14.1],[36.,9.,46.0]])# prueba
...
R1=np.array([-3.916419919645695E-02,9.318160120048884E-01,4.039236491098135E-01])
R2=np.array([-2.068851717348906E-01,9.132770535147879E-01,3.958800809868199E-01])
R3=np.array([-3.688942164347718E-01,8.690938354463085E-01,3.767267647401619E-01])
#print(R2)

#tiempo en kt (gaussian)

#T=[2458191.8942,2458192.9733,2458193.82275]
T=[2458293.5,2458303.5,2458313.5]#prueba
...
while finale==False: 
    ...
    f3=f[2]
    """
    f1=f(r2_ciclo,r2_punto_ciclo,t[0])
...
hz= h[2]
i=np.rad2deg(np.arccos(hz/np.linalg.norm(h)))#entre 0 y 90°
#print(i)
